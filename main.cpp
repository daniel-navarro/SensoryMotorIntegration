...
int main (int argc, char *argv[]) {
	...
	#ifdef OMP_ENABLE
		int numberOfThreads = (3 * omp_get_num_procs())/4; // Ben's advice, uses 75% of cores
	#else
	...
	if(argc - i < 3)
		cout << "Expected at least three arguments." << endl;
	else {
		...
		if(strcmp("build", argv[i]) == 0) {
            ...
            cout << endl << endl << endl << endl << "==== Daniel ====" << endl;
            cout << "paramFile: " << paramFile << endl;
            cout << "net: " << net << endl;
            cout << "dataFile: " << dataFile << endl;
            cout << "outputDir: " << outputDir << endl;
            cout << "==== Daniel ====" << endl << endl << endl;
